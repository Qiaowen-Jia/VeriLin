...
public class PerformanceTest {
    ...
    private final static int COACH_NUM = 15;
    private final static int SEAT_NUM = 100;
    private final static int STATION_NUM = 10;

    private final static int TEST_NUM = 500000;
    private final static int refund = 5;
    private final static int buy = 15;
    private final static int query = 80;
    private final static int thread = 96;
    ...
    public static void main(String[] args) throws InterruptedException {
        final int[] threadNums = {96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96};
        int p;
        long buyAvgTimeSum = 0;
        long refundAvgTimeSum = 0;
        long inquiryAvgTimeSum = 0;
        long throughOutSum = 0;
        for (p = 0; p < threadNums.length; ++p) {
            ...
            buyAvgTimeSum += buyAvgTime;
            refundAvgTimeSum += refundAvgTime;
            inquiryAvgTimeSum += inquiryAvgTime;
        ...
        System.out.println(String.format(
                "BuyAvgTime(ns): %d RefundAvgTime(ns): %d InquiryAvgTime(ns): %d ThroughOut(t/s): %d",
                buyAvgTimeSum / threadNums.length, refundAvgTimeSum / threadNums.length, inquiryAvgTimeSum / threadNums.length, throughOutSum / threadNums.length));
    }
