...
class ThreadIdTest {
	...
	private static final AtomicInteger nextId = new AtomicInteger(0);	// SDP：AtomicInteger实现原子性操作 (getAndIncrement)

	// Thread local variable containing each thread's ID
	private static final ThreadLocal<Integer> threadId =				// SDP：ThreadLocal隔离线程变量
...
public class Test {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		long returnTicketTime = 0;
		long buyTicketTime = 0;
		long inquiryTicketTime = 0;
