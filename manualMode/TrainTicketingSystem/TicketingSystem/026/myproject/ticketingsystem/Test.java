...
public class Test {
	...
	private final static int thread = 256;
	...
	public static void main(String[] args) throws InterruptedException {
		final int[] threadNums = {4, 8, 16, 32, 64 ,128,256};
		int p;
		for (p = 0; p < threadNums.length; ++p) {
			final TicketingDS tds = new TicketingDS(ROUTE_NUM, COACH_NUM, SEAT_NUM, STATION_NUM, threadNums[p]);
			//final TicketingDS tds = new TicketingDS(ROUTE_NUM, COACH_NUM, SEAT_NUM, STATION_NUM, 1);
