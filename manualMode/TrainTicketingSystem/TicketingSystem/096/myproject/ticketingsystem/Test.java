...
public class Test {
	...
	*/
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// LogUtil.Log(String.format("ThreadNum:" + threadnum + "TestNum:" + testnum + " routeNum:" + routenum +
		// 			   " coachNum:" + coachnum + " seatNum:" + seatnum + " stationNum:" + stationnum));
		// LogUtil.Log(String.format("Format:"));
		// LogUtil.Log(String.format("preTime postTime ThreadId TicketRefund tid passenger route coach departure arrival seat"));
		// LogUtil.Log(String.format("preTime postTime ThreadId TicketBought tid passenger route coach departure arrival seat"));
		// LogUtil.Log(String.format("preTime postTime ThreadId TicketSoldOut route departure arrival"));
		// LogUtil.Log(String.format("preTime postTime ThreadId RemainTicket leftTicket route departure arrival"));
		// LogUtil.Log(String.format("Trace:"));
