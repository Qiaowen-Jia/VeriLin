...
public class SimpleBenchmark {
	final static int threadnum = 64; // 64 for benchmark
	final static int routenum = 20; // 20 for benchmark
	final static int coachnum = 10; // 10 for benchmark
	final static int seatnum = 100; // 100 for benchmark
	final static int stationnum = 16; // 16 for benchmark
	...
	*/
	...
	for (int i = 0; i< threadnum; i++) {
            			...
            			if (0 <= sel && sel < retpc && soldTicket.size() > 0) { // return ticket
           				...
           				if ((ticket = soldTicket.remove(select)) != null) {
            				...
            				if ((ticket = tds.buyTicket(passenger, route, departure, arrival)) != null) {
											long postTime = System.nanoTime() - startTime;
            					// System.out.println(presTime + " " + postTime + " " + ThreadId.get() + " " + "TicketBought" + " " + ticket.tid + " " + ticket.passenger + " " + ticket.route + " " + ticket.coach + " " + ticket.departure + " " + ticket.arrival + " " + ticket.seat);
        ...
        long totalOper = threadnum * testnum;
        System.err.println("Result: operation: " + totalOper + "total time: " + totalTime + "ns");
        System.err.println("Result: op/s: " + (totalOper*1000000000/totalTime));
	}
}
