...
public class Test {
    ...
    private final static int buy = 20;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (p = 0; p < threadNums.length; ++p) {
            ...
            System.out.println(String.format(
                    "线程数: %d 购票平均时间: %d 纳秒   退票平均时间: %d 纳秒    查票平均时间: %d 纳秒   总执行时间: %f 秒     吞吐量(t/s): %d",
                    threadNums[p], buyAvgTime, refundAvgTime, inquiryAvgTime,((double)time)/1000, t));
            clear();
        }
    }
